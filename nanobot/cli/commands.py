...
def onboard(
    ...
    console.print(
        "\n[dim]Want Telegram/DingTalk/Slack? See: https://github.com/HKUDS/nanobot#-chat-apps[/dim]"
    )
...
def serve(
    ...
    agent_loop = AgentLoop(
        ...
        wechat_rss_config=runtime_config.tools.wechat_rss,
...
def gateway(
    ...
    agent = AgentLoop(
        ...
        wechat_rss_config=config.tools.wechat_rss,
        cron_service=cron,
